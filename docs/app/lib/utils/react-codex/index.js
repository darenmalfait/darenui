...
// import {ClipboardCopyButton} from '../../../components/clipboard-copy-button.tsx'
...
export default class Editor extends React.Component {
  constructor(props) {
    ...
    this._highlight = React.createRef()
  }
  ...
  render() {
    const {style, lineNumber, lineWrap, className, language, readOnly} =
      this.props
      ...
      <div style={{...styles.container, ...style}} className={className}>
        ...
        {/* {showClipBoard ? (
          <ClipboardCopyButton
            ...
            className="absolute top-6 right-4 z-10 opacity-0 group-hover:opacity-100"
          />
        ) : null} */}
      </div>
    )
