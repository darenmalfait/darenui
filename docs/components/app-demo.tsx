...
import {ChefHat, HistoryIcon, UtensilsIcon} from 'lucide-react'
...
function AppDemo() {
  return (
    <div className="hidden rounded-md border border-gray-200 bg-gradient-to-b from-daren-100 to-daren-900 shadow-2xl dark:border-gray-800 xl:block">
      <div className="p-8">
              ...
              <div className="space-y-4">
                <div className="px-6">
                  ...
                  <NavigationList className="space-y-1">
                    ...
                    />
                    <NavigationList.Item icon={Squares2X2Icon} title="Browse" />
                  </NavigationList>
                </div>
                <div className="px-6 py-2">
                  ...
                  <NavigationList className="space-y-1">
                    <NavigationList.Item icon={HistoryIcon} title="History" />
                    <NavigationList.Item icon={UserIcon} title="Your uploads" />
                  </NavigationList>
                </div>
              </div>
            </aside>
...
function AlbumArtwork({
  ...
  return (
    <div className={cx('space-y-3 group', className)} {...props}>
      <div
        className={cx('object-cover rounded-md', {
          'aspect-w-1 aspect-h-1': aspectRatio === 'square',
          'aspect-w-3 aspect-h-4': aspectRatio === 'portrait',
        })}
      >
        <Image
          src={album.cover}
