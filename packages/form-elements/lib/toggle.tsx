    ...
    <button onClick={(e: React.MouseEvent<HTMLElement>) => e.stopPropagation()}>
      ...
      <Switch
        ...
        className={cx(
          ...
          'focus:ring-primary group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent shadow-inner transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2',
        )}
      >
